...
public interface IDataReader
{
    ...
    IEnumerable<T> Read<T>(string searchTerm) where T : Model;
    ...
    /// <typeparam name="T">The type of the model to look for.</typeparam>
    /// <returns>A list of <typeparamref name="T"/> models.</returns>
    Task<IEnumerable<T>> ReadAsync<T>(string searchTerm) where T : Model;
    ...
    /// <typeparam name="T">The type of the model to look for.</typeparam>
    /// <returns>A list of <typeparamref name="T"/> models.</returns>
    IEnumerable<T> Read<T>(T model, bool exact) where T : Model;
    ...
    /// <typeparam name="T">The type of the model to look for.</typeparam>
    /// <returns>A list of <typeparamref name="T"/> models.</returns>
    Task<IEnumerable<T>> ReadAsync<T>(T model, bool exact) where T : Model;
}